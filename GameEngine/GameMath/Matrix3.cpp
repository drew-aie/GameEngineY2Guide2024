...
GameMath::Matrix3 GameMath::Matrix3::operator+(GameMath::Matrix3 rhs)
{
    return 
        GameMath::Matrix3(
...
GameMath::Vector3 GameMath::Matrix3::operator*(GameMath::Vector3 rhs)
{
    return 
        GameMath::Vector3(
...
bool GameMath::Matrix3::operator==(GameMath::Matrix3 rhs)
{
    return
        m00 == rhs.m00 && m01 == rhs.m01 && m02 == rhs.m02 &&
        m10 == rhs.m10 && m11 == rhs.m11 && m12 == rhs.m12 &&
...
{
    return GameMath::Matrix3(
		cos(radians), -sin(radians), 0,
		sin(radians), cos(radians), 0,
		0, 0, 1);
}

GameMath::Matrix3 GameMath::Matrix3::createTranslation(GameMath::Vector2 position)
{
    return GameMath::Matrix3(
		1, 0, position.x,
		0, 1, position.y,
...
GameMath::Matrix3 GameMath::Matrix3::createScale(GameMath::Vector2 scale)
{
    return GameMath::Matrix3(
		scale.x, 0, 0,
		0, scale.y, 0,
